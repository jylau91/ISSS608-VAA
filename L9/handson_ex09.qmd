...
## **9.1.2 Installing and launching R packages**
...
## **9.1.4 Plotting Ternary Diagram with R**

### **9.1.4.1 4.1 Plotting a static ternary diagram**
...
### **9.1.4.2 Plotting an interative ternary diagram**
...
## **9.2.2 Installing and Launching R Packages**
...
## **9.2.3 Importing and Preparing The Data Set**
...
## **9.2.4 Building Correlation Matrix: *pairs()* method**
...
### **9.2.4.1 Building a basic correlation matrix**
...
### **9.2.4.2 Drawing the lower corner**
...
### **9.2.4.3 Including with correlation coefficients**
...
## **9.2.5 Visualising Correlation Matrix: ggcormat()**
...
### **9.2.7.1 Getting started with corrplot**
...
### **9.2.7.2 Working with visual geometrics**
...
### **9.2.7.4 Working with mixed layout**
...
### **9.2.7.5 Combining corrgram with the significant test**
...
### **9.2.7.7 Reordering a correlation matrix using hclust**
...
## **9.3.2 Installing and Launching R Packages**
...
## **9.3.3 Importing and Preparing The Data Set**
...
### **9.3.3.1 Importing the data set**
...
### **9.3.3.3 Transforming the data frame into a matrix**
...
## **9.3.5 Creating Interactive Heatmap**
...
### **9.3.5.1 Working with heatmaply**
...
### **9.3.5.7 Working with colour palettes**
...
## **9.4.2 Installing and Launching R Packages**
...
## **9.4.4 Plotting Static Parallel Coordinates Plot**
...
### **9.4.4.1 Plotting a simple parallel coordinates**
...
### **9.4.4.2 Plotting a parallel coordinates with boxplot**
...
### **9.4.4.3 Parallel coordinates with facet**
...
### **9.4.4.4 Rotating x-axis text label**
...
### **9.4.4.5 Adjusting the rotated x-axis text label**
...
## **9.4.5 Plotting Interactive Parallel Coordinates Plot: parallelPlot methods**
...
### **9.4.5.3 Changing the colour scheme**
...
### **9.4.5.4 Parallel coordinates plot with histogram**
...
## **9.5.2 Installing and Launching R Packages**
...
### **9.5.3.1 Importing the data set**
...
### **9.5.3.2 Data Wrangling and Manipulation**
...
### **9.5.3.3 Grouped summaries without the Pipe**
...
### **9.5.3.4 Grouped summaries with the *pipe***
...
### **9.5.4.1 Designing a static treemap**
...
### **9.5.4.2 Using the basic arguments**
...
### **9.5.4.3 Working with *vColor* and *type* arguments**
...
## **9.5.5 Designing Treemap using treemapify Package**
...
### **9.5.5.1 Designing a basic treemap**
...
## **9.5.6 Designing Interactive Treemap using d3treeR**

### **9.5.6.1 Installing *d3treeR* package**
...
### **9.5.6.2 Designing An Interactive Treemap**
