...
As part of Take-Home Exercise 1, we were required to reference a fellow student's exercise. A thought of how referenced each site was then ocurred, I did some webscrapping in Python using [BeautifulSoup](https://beautiful-soup-4.readthedocs.io/en/latest/) based on the netlify links of students provided.
