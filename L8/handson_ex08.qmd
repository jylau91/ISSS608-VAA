...
### **8.1.3.2 Importing Geospatial Data into R**
...
We can call the variable loaded "mpsz" to view the shapefile, only 10 rows are displayed as sf package uses tibble to represent simple feature data.

```{r}
print(mpsz)
#print (mpsz, n = 20) for more rows.
```

### **8.1.3.3 Importing Attribute Data into R**
...
#### 8.1.3.4.2 Joining the attribute data and geospatial data
...
## **8.1.4 Choropleth Mapping Geospatial Data Using *tmap***
...
### **8.1.4.1 Plotting a choropleth map quickly by using *qtm()***
...
### **8.1.4.2 Creating a choropleth map by using *tmap*’s elements**
...
#### 8.1.4.2.2 Drawing a choropleth map using *tm_polygons()*
...
#### 8.1.4.2.3 Drawing a choropleth map using *tm_fill()* and \*tm_border()\*\*
...
### **8.1.4.3 Data classification methods of tmap**
...
#### 8.1.4.3.1 Plotting choropleth maps with built-in classification methods
...
# Pretty (default)
tm_shape(mpsz_pop2020) +
  tm_polygons("DEPENDENCY", style = "pretty", n = 5) +
  tm_borders() +
...
tm_shape(mpsz_pop2020) +
  ...
  tm_borders() +
  tm_layout(title = "Quantile Classification")

# Equal Interval
tm_shape(mpsz_pop2020) +
  tm_polygons("DEPENDENCY", style = "equal", n = 5) +
  tm_borders() +
  tm_layout(title = "Equal Interval Classification")

# Jenks (Natural Breaks)
tm_shape(mpsz_pop2020) +
  tm_polygons("DEPENDENCY", style = "jenks", n = 5) +
  tm_borders() +
  tm_layout(title = "Jenks (Natural Breaks) Classification")

# Standard Deviation
tm_shape(mpsz_pop2020) +
  tm_polygons("DEPENDENCY", style = "sd", n = 5) +
  tm_borders() +
  tm_layout(title = "Standard Deviation Classification")
```
...
# 2 classes
tm_shape(mpsz_pop2020) +
  tm_polygons("DEPENDENCY", style = "quantile", n = 2) +
  tm_borders() +
  tm_layout(title = "Quantile, 2 Classes")

# 6 classes
tm_shape(mpsz_pop2020) +
  tm_polygons("DEPENDENCY", style = "quantile", n = 6) +
  tm_borders() +
  tm_layout(title = "Quantile, 6 Classes")

# 10 classes
tm_shape(mpsz_pop2020) +
  tm_polygons("DEPENDENCY", style = "quantile", n = 10) +
  tm_borders() +
  tm_layout(title = "Quantile, 10 Classes")

# 20 classes
tm_shape(mpsz_pop2020) +
  tm_polygons("DEPENDENCY", style = "quantile", n = 20) +
  tm_borders() +
  tm_layout(title = "Quantile, 20 Classes")

```

#### 8.1.4.3.2 Plotting choropleth map with custom break
...
### **8.1.4.4 Colour Scheme**

**tmap** supports colour ramps either defined by the user or a set of predefined colour ramps from the **RColorBrewer** package.

#### 8.1.4.4.1 Using ColourBrewer palette
...
#### 8.1.4.5.3 Cartographic Furniture
...
### **8.1.4.6 Drawing Small Multiple Choropleth Maps**
...
#### 8.1.4.6.1 By assigning multiple values to at least one of the aesthetic arguments
...
#### 8.1.4.6.2 By defining a group-by variable in *tm_facets()*
...
#### 8.1.4.6.3 By creating multiple stand-alone maps with `tmap_arrange()`
...
### **8.1.4.7 Mappping Spatial Object Meeting a Selection Criterion**
...
### **8.1.5.1 All about tmap package**
...
### **8.1.5.2 Geospatial data wrangling**
...
# **8.2  Visualising Geospatial Point Data**
...
# **8.2.3 Geospatial Data Wrangling**
...
![](images/clipboard-129759040.png)

## **8.2.3.2 Data Import and Preparation**
...
## **8.2.3.3 Creating a sf data frame from an aspatial data frame**
...
![](images/clipboard-3201107011.png)
...
# **8.2.4 Drawing Proportional Symbol Map**
...
## **8.2.4.1 It all started with an interactive point symbol map**
...
## **8.2.4.2 Lets make it proportional**
...
## **8.2.4.3 Lets give it a different colour**
...
## **8.2.5.1 All about tmap package**
...
## **8.2.5.2 Geospatial data wrangling**
...
### **8.3.2.1 Installing and loading packages**

```{r}
pacman::p_load(tmap, tidyverse, sf)
```

### **8.3.2.2 Importing data**
...
## **8.3.3 Basic Choropleth Mapping**

### **8.3.3.1 Visualising distribution of non-functional water point**
...
## **8.3.4 Choropleth Map for Rates**

In much of our readings we have now seen the importance to map rates rather than counts of things, and that is for the simple reason that water points are not equally distributed in space. That means that if we do not account for how many water points are somewhere, we end up mapping total water point size rather than our topic of interest.

### **8.3.4.1 Deriving Proportion of Functional Water Points and Non-Functional Water Points**
...
#### 8.3.5.1.2 Why writing functions?
...
#### 8.3.5.1.3 Creating the get.var function
...
#### 8.3.5.1.4 A percentile mapping function
...
#### 8.3.5.1.5 Test drive the percentile mapping function
...
#### 8.3.5.2.1 Creating the boxbreaks function
...
#### 8.3.5.2.2 Creating the get.var function
...
#### 8.3.5.2.3 Test drive the newly created function
